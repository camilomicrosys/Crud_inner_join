...
//me traigo el modelo del admin por que en el index muestro el total de usuarios entonces lo traigo aca para ejecutar la consulta y pasdarla a la vista en iniciologin
...
// si cumplio con los datos requeridos de formulario
            ...
            $datos_usuario = $usuarios->obtenerUsuario(['username' => $usuario]);
...
//si tenemos problemas con las validaciones lo redirigimos esta funcion es la que redirecciona atras para cuando el formulario este malo no lo deja avanzar si no que se retrocede wit input es para que no pierda los datos escritos en el formulario
    ...
    {
        //objeto con todos los usuarios para pasarlos a la vista
        $objetoAdministrador = new Loginmodel();
        $usuarios            = $objetoAdministrador->totalUsuariosEnbaseDatos();
        ...
        echo view('login/inicioapp', $data);
